...
<div id="searchgrid">
    <telerik:RadGrid ID="rgUsers" runat="server" AllowAutomaticDeletes="True" AutoGenerateColumns="False"
        ...
        <MasterTableView CommandItemDisplay="Top" DataKeyNames="Username" TableLayout="Fixed" CellSpacing="-1" Width="100%">
...
<EditColumn FilterControlAltText="Filter EditCommandColumn column"></EditColumn>
        ...
        <CommandItemTemplate>
            ...
            <table width="100%">
                <tr>
                    <td>
                        <asp:LinkButton ID="ibtEditCompany" runat="server" CommandName="EditCompany" ToolTip="Click to edit company details"> <img id="imgEditC" alt="" runat="server" src="~/usercontent/default/edit.gif" style="border:0px" />Edit Company </asp:LinkButton> 
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <asp:LinkButton ID="ibtTreeView" runat="server" CommandName="ViewDownLine" ToolTip="Click to view tree structure of selected company"> <img id="imgViewCTree" alt="" runat="server" src="~/usercontent/default/TreeView.gif" style="border:0px" />View Tree Structure </asp:LinkButton>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        ...
                        OnClientClick="return confirm('Are you sure you want to bulk move the selected users to the currently selected company');"> <img id="imgMove" alt="" runat="server" src="~/usercontent/default/edit.gif" style="border:0px" />Change User Company </asp:LinkButton>
                   </td>
                   <td>
                        ...
                        <telerik:RadComboBox ID="cboType" runat="server" ToolTip="Select which user criteria you want to use to search"
                         Width="100px" OnClientLoad="onLoad" >
                            <Items>
                                ...
                                <telerik:RadComboBoxItem runat="server" Text="Active Users" Visible="False" />
                                <telerik:RadComboBoxItem runat="server" Text="Inactive Users" Visible="False" />
                    ...
                    <td>
                        ...
                        <telerik:RadComboBox ID="cboSearch" runat="server" ToolTip="Select field to search" Width="100px" OnClientLoad="onLoad">
                            <Items>
                                ...
                                <telerik:RadComboBoxItem runat="server" Text="External ID" 
                                    Value="External ID" />
                            </Items>
                            <CollapseAnimation Duration="200" Type="OutQuint" />
                        </telerik:RadComboBox>
                        &nbsp;&nbsp;
                        <asp:LinkButton ID="btnSearch" runat="server" ToolTip="Click here to search" OnClick="Searching_Users" > <asp:Image ID="Image4" runat="server" ImageUrl="~/usercontent/default/searchone.gif" BorderStyle="None" BorderWidth="0px" />Go </asp:LinkButton>
                        </asp:Panel>
                    </td>
            </tr>
            <tr>
                    <td colspan="4">
                        <asp:LinkButton ID="btnAddUser" runat="server" CommandName="InitInsert" ToolTip="Click here to add a new user"> <img src="UserContent/default/adduser.gif" style="border:0px"/>Add User </asp:LinkButton>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <asp:LinkButton ID="btnUserImport" runat="server" ToolTip="Click here to import users" CommandName="Import"> <img src="UserContent/default/importusers.gif" style="border:0px"/>Import User(s) </asp:LinkButton>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <asp:LinkButton ID="btnDeleteUser" runat="server" CommandName="Delete" OnClientClick="javascript:return confirm('Are you sure you want to delete this user?')"> <img src="UserContent/default/delete.gif" style="border:0px" />Delete User(s) </asp:LinkButton>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <asp:LinkButton ID="btnRestore" runat="server" CommandName="Restore"> <img src="UserContent/default/insert.gif" style="border:0px" />Restore User(s) </asp:LinkButton>
                        &nbsp;&nbsp;|&nbsp;&nbsp;
                        <asp:LinkButton ID="btnRefresh" runat="server" CommandName="RebindGrid"> <img src="UserContent/default/Refresh.gif" style="border:0px" />Refresh Grid </asp:LinkButton>
                    </td>
                </tr>
            </table>
        </div>
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn AllowFiltering="False" Groupable="False">
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="Status">
                                       ...
                                       <HeaderStyle Width="95px" />
                                        <ItemTemplate>
                                            ...
                                            <asp:Image ID="imgOcr" runat="server" 
                                                ImageUrl="~/UserContent/default/OCR.gif" ToolTip="OCR Blank User" />
                                            <asp:Image ID="imgTopOCR" runat="server" 
                                                ImageUrl="~/UserContent/default/TopOcr.gif" ToolTip="OCR Top User" />
                                            <asp:Image ID="imgDollar" runat="server" 
                                                ImageUrl="~/UserContent/default/dollar.png" ToolTip="PrePaid User" />
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="Name" DataType="System.string" FilterImageUrl="~/Skins/Default2006/Filter.gif"
                                        HeaderText="Company" SortAscImageUrl="~/Skins/Default2006/Grid/SortAsc.gif" SortDescImageUrl="~/Skins/Default2006/Grid/SortDesc.gif"
    ...
    <telerik:RadNotification ID="RadNotification1" runat="server" Animation="Slide" 
        AnimationDuration="1000" ContentIcon="none" EnableRoundedCorners="True" 
        EnableShadow="True" Height="120px" Opacity="70" Skin="Hay" Width="170px">
        <ContentTemplate>
            <table class="style1">
                <tr>
