        ...
        <tr>
            <td colspan="3">
                ...
                <telerik:RadGrid ID="RadGrid1" runat="server" 
                    ...
                    Visible="False" AutoGenerateColumns="False" CellSpacing="0">
                    ...
                    <MasterTableView DataMember="DefaultView"
                       ...
                       <asp:Button ID="cmdExport" runat="server" Text="Export to Excel"  
                                CommandName="Export" Visible="true" onclick="cmdExport_Click"/>
...
&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                &nbsp;<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="select bf.*, s.Status from batchfax bf left outer join rightfax10..documents d on d.handle = bf.FaxID left outer join Status s on d.TermStat = s.ID where bf.BatchID = @BatchID">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="cboProduct" Name="BatchID" 
