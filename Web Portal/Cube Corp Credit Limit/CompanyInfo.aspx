...
<div id="validation">
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                ControlToValidate="txtAdminEmail" ErrorMessage="Incorrect Email Syntax" 
                ForeColor="Red" 
                ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" SetFocusOnError="True" ValidationGroup="submit"></asp:RegularExpressionValidator>
...
<div id="field" style="width:auto!Important">
    ...
    <div> 
        ...
        Text="Business Partner" ToolTip="Inbound pages will be billed" />
             ...
             <asp:CheckBox ID="chkUseCoverpage" runat="server" Text="Use Standard Coverpage" 
                 ToolTip="Use Standard Coverpage" Checked="True" Visible="False" />
        </div>
          </div>
    ...
    <div id="validation" class="validation">
        ...
        <hr />
<div id="formContainerHalf">
 <asp:Panel ID="GroupLimitPanel" runat="server">
        <h5>
            Group Code Limitation</h5>
        <div ID="label">
            <asp:Label ID="lblGroupHeading" runat="server" ForeColor="#CC0000"></asp:Label>
        </div>
        <div ID="clear">
        </div>
        <div ID="label">
        ...
        <div ID="label">
            Payment</div>
        <div ID="field">
            <telerik:RadNumericTextBox ID="txtGPayment" runat="server" AutoPostBack="True" 
                MinValue="0">
            </telerik:RadNumericTextBox>
        </div>
        <div ID="validation">
        ...
        <div ID="label">
            <asp:Label ID="Label1" runat="server" Text="Limit:"></asp:Label>
        </div>
        <div ID="field">
        ...
        <div ID="label">
            <asp:Label ID="Label3" runat="server" Text="Suspended:"></asp:Label>
        </div>
        <div ID="field">
            <asp:CheckBox ID="chkGSuspended" runat="server" AutoPostBack="True" />
        </div>
        <div ID="validation">
        </div>
        <div ID="clear">
        ...
        <div ID="label">
            <asp:Label ID="lblPercentage" runat="server" ForeColor="#CC0000"></asp:Label>
        </div>
        <div ID="clear">
        </div>
        <div ID="field">
...
<div id="formContainerHalf">
 <asp:Panel ID="CompanyLimitPanel" runat="server">
     <h5>Company Limitation</h5>
<div id="label">
    <asp:Label ID="lblCreditNote" runat="server" ForeColor="Red"></asp:Label></div>
<div id="clear">
    </div>

<div id="label">
    <asp:Label ID="lblBalance" runat="server" Text="Credit Balance"></asp:Label></div>
<div id="field">
...
<div id="field">  <telerik:RadNumericTextBox ID="txtCPayment" runat="server" AutoPostBack="True" 
            MinValue="0">
        </telerik:RadNumericTextBox></div>
<div id="validation">
 <asp:Label ID="lblCPayment" runat="server" ForeColor="Red"></asp:Label></div>


<div id="clear"></div>
<div id="label">
    <asp:Label ID="lblLimit" runat="server" Text="Credit Limit"></asp:Label></div>
<div id="field">
 ...
 <div ID="label">
    ...
    <div ID="validation">
        <asp:LinqDataSource ID="ldsLevels" runat="server" 
            ...
            TableName="Levels" Where="Deleted == @Deleted" EntityTypeName="">
            <WhereParameters>
