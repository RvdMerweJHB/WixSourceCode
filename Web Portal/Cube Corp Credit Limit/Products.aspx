...
<asp:Panel ID="Panel1" runat="server">
    <table cellpadding="3px">
        ...
        <tr>
            <td>
                <asp:Label ID="Label6" runat="server" Text="Commission type:" Visible="False"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label ID="Label9" runat="server" Text="Regular expression:" 
        ...
        <tr>
            <td colspan="2">
                <asp:Label ID="Label28" runat="server" Text="Levels:" Visible="False"></asp:Label>
            </td>
        </tr>
        <tr>
            <td colspan="2">
