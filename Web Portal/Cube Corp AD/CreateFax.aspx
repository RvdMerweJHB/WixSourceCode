        ...
        <tr>
            ...
            <td>
                <telerik:RadComboBox ID="cboCoverPage" runat="server" AutoPostBack="True" 
                    CausesValidation="False" DataSourceID="LinqDataSource1" 
                    DataTextField="CoverPage" DataValueField="CoverPageID" EmptyMessage="(None)" 
                    Visible="False">
                        <collapseanimation duration="200" type="OutQuint"></collapseanimation>
                    </telerik:RadComboBox>
                <asp:LinqDataSource ID="LinqDataSource1" runat="server" 
                    ContextTypeName="CUBE.DBDataContext" OrderBy="CoverPage" 
                    Select="new (CoverPageID, CoverPage)" TableName="CoverPages" 
                    Where="CompanyID == @CompanyID &amp;&amp; Deleted == @Deleted">
                    <WhereParameters>
