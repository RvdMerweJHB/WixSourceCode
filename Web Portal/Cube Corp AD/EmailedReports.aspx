...
<div id="field">
    <span class="validation">
    <telerik:RadComboBox ID="rcbCompany" Runat="server" nclientload="onLoad" AllowCustomText="False" MarkFirstMatch="True">
    </telerik:RadComboBox>
    </span></div>
<div id="validation">
</div>
...
<div id="clear"></div>
<div id="label">
    <asp:Label ID="lblrecur" runat="server" Text="Occurance"></asp:Label>
</div>
<div id="field">
...
<li>Daily - Generated on Next day</li> 
<li>Weekly - Generated on&nbsp; Sunday</li> 
