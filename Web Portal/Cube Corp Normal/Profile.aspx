    ...
    <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="cmdForward">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="litFaxF" 
...
<div id="clear"></div>
<div id="label">
    <asp:Label ID="lblForward" runat="server" Text="Forward Faxes"></asp:Label>
    </div>
<div id="field">
    <telerik:RadTextBox ID="txtForward" runat="server" ValidationGroup="ForwardFax"></telerik:RadTextBox>
</div>
<div id="validation">
    <asp:Button ID="cmdForward" Text="Forward" 
        ToolTip="Click to forward faxes to another number" runat="server" 
        ValidationGroup="ForwardFax" />
</div>
...
<div id="clear"></div>
<div id="label">
    <asp:Label ID="lblNotification" runat="server" Text="Notification Settings"></asp:Label>
</div>
<div id="field">
...
<div id = "field"  class="submitButton" style="width:auto!important">
    <asp:CheckBox ID="chkTerms" runat="server" AutoPostBack="True" 
        Text="Accept Terms &amp; Conditions" Checked="True" /></div>
</div>
</asp:Content>
